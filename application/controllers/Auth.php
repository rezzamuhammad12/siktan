...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        $this->form_validation->set_rules('no_hp', 'no_hp', 'required|trim|numeric|is_unique[user.no_hp]', [
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'tuyulaveria01@gmail.com',
            'smtp_pass' => 'siktanjabar123',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('tuyulaveria01@gmail.com', 'Web Programming UNPAS');
