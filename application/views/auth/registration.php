            ...
            <div class="row">
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user registration" method="post" action="<?= base_url('auth/registration'); ?>">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="no_hp" name="no_hp" placeholder="Nomor Telphone / Hp" value="<?= set_value('no_hp'); ?>">
